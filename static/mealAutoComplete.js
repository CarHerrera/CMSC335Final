...
async function autocomplete(inp, ls) {
    /*the autocomplete function takes two arguments,
    the text field element and an array of possible autocompleted values:*/
    let arr = await ls;
    
    if (!arr || !Array.isArray(arr)) {
        console.error("Autocomplete: Data is not an array", arr);
        return;
    }
    let currentFocus;
    ...
    inp.addEventListener("input", function(e) {
        ...
        //   document.getElementById("drinkAlert").classList.add('hidden')
        // }
        // console.log(arr);
...
// console.log(meal_ingr);
autocomplete(document.getElementById("foodInput"), meal_ingr);
